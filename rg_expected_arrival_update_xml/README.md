...
- When a Purchase Order Line Expected Arrival is created or changed → open stock moves receive the new Scheduled Date (standard Odoo only updates the Deadline).
